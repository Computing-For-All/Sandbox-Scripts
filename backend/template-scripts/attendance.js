...
import {isClassDay, mapName} from '../template-scripts/utils/utils.js'
...
let attendancePath = '../template-scripts/test_data/winter-23-attendance'
let outputPath = '../template-scripts/output/winter-attendance.csv'
